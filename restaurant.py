...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="JUST IN TIME FOOD",fg="steel blue",bd=10,anchor='w')
...
def Ref():
    ...
    costoffries = cof*140
    costoflargefries = colfries*70
    costofburger = cob*100
    costoffilet = cofi*90
    costofcheeseburger = cochee*100
    ...
    ser_charge=((costoffries +  costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks)*0.1)
    Service="Rs.",str('%.2f'% ser_charge)
    PayTax = (((costoffries + costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks)-ser_charge) * 0.12)
    OverAllCost="Rs.",str( Totalcost+PayTax - ser_charge)
    PaidTax="Rs.",str('%.2f'% PayTax)

    Service_Charge.set(Service)
    cost.set(costofmeal)
    Tax.set(PaidTax)
    Subtotal.set(Totalcost-ser_charge)
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By BENNETTIANS",bd=2,relief=SUNKEN)
...
lblfries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Roti with Shahi paneer",fg="steel blue",bd=10,anchor='w')
lblfries.grid(row=1,column=0)
txtfries = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Fries , bd=6,insertwidth=4,bg="powder blue" ,justify='right')
txtfries.grid(row=1,column=1)

lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Chole bhature",fg="steel blue",bd=10,anchor='w')
...
lblburger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Rajma chawal",fg="steel blue",bd=10,anchor='w')
lblburger.grid(row=3,column=0)
txtburger = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Burger , bd=6,insertwidth=4,bg="powder blue" ,justify='right')
txtburger.grid(row=3,column=1)

lblFilet = Label(f1, font=( 'aria' ,16, 'bold' ),text="Kadhi chawal",fg="steel blue",bd=10,anchor='w')
lblFilet.grid(row=4,column=0)
txtFilet = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Filet , bd=6,insertwidth=4,bg="powder blue" ,justify='right')
txtFilet.grid(row=4,column=1)

lblCheese_burger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Biryani",fg="steel blue",bd=10,anchor='w')
...
#--------------------------------------------------------------------------------------
lblDrinks = Label(f1, font=( 'aria' ,16, 'bold' ),text="Coffee/Tea",fg="steel blue",bd=10,anchor='w')
...
lblService_Charge = Label(f1, font=( 'aria' ,16, 'bold' ),text="Discount",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Roti with Shahi paneer", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="140", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Chole bhature", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="70", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Rajma chawal", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="100", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Kadhi chawal", fg="steel blue", anchor=W)
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Coffee/Tea", fg="steel blue", anchor=W)
